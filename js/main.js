function getCityCoordinates() {
  ...
  fetch(url) 
    ...
    .then(data => {
      ...
      //5th step is finally the display command itself:
      weatherCardsDiv.innerHTML = html;                     //again... the cards are displayed in div "weather-cards" defined by weatherCardsDiv
